...
class AuthRepositoryImpl :AuthRepository {
    ...
    override fun sendVerificationEmail(onSuccess: () -> Unit, onError: (error: Throwable?) -> Unit) {
    ...
    override suspend fun login(email: String, password: String): Flow<Response<AuthResult?>> = callbackFlow{
        try {
    ...
    override suspend fun signInWithCredentials(credential: AuthCredential): Flow<Response<AuthResult?>> = callbackFlow{
        try {
            trySend(Response.Loading())
    ...
    override suspend fun sendPasswordResetLink(email: String): Flow<Response<Boolean>> = callbackFlow{
       try {
           trySend(Response.Loading())
